# python3.9
# time:2024/11/11
# CNN:dotproduct attention mechanism  GRU:simple attention mechanism
...
x_false_train, x_false_test, y_false_train, y_false_test = train_test_split(sequence_false, y_false, test_size=0.9, random_state=30)  # 0.9，0.65 30：0.986 100：0.986 测试到320
